  ...
  return (
    <Layout>
      ...
      <main>
        <section className="relative isolate mx-auto min-h-[680px] max-w-[1240px] overflow-hidden px-5 pb-16 pt-14 lg:min-h-[700px] lg:px-8 lg:pt-20">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[.9fr_1.1fr]">
            <div className="animate-rise relative z-10 max-w-xl">
              ...
              <h1 className="max-w-lg font-display text-[clamp(2.8rem,6vw,5.4rem)] leading-[.98] tracking-[-.03em] text-[#16241c]">Nutrición que se nota.<br /><em className="not-italic text-[#0d7a3f]">Bienestar que se vive.</em></h1>
              <p className="mt-7 max-w-md text-base leading-7 text-[#4b5b52]">Soy Adrian, Asociado Independiente de Herbalife Nutrition en Guadalajara. Te acompaño a mejorar tu alimentación y bienestar, o a construir un ingreso propio — sin presión, con información clara.</p>
              ...
              <div className="mt-12 flex items-center gap-3 text-xs text-[#5b6b62]"><ShieldCheck size={18} className="text-[#0d7a3f]" /> Información clara. Decisiones tuyas.</div>
            </div>
        ...
        <section className="border-y border-[#e3f0e8] bg-[#0b1722] hidden">{/* seccion antigua eliminada */}</section>
        ...
        <section className="border-y border-[#e3f0e8] bg-[#f6fbf8]">
          <div className="mx-auto grid max-w-[1240px] items-center gap-12 px-5 py-20 lg:grid-cols-[.8fr_1.2fr] lg:px-8 lg:py-28">
            <div className="relative overflow-hidden rounded-[2rem] border border-[#e3f0e8] bg-white p-2 shadow-[0_20px_50px_rgba(6,48,28,.08)]">
              ...
              <div className="absolute -right-3 -top-3 h-28 w-28 overflow-hidden rounded-2xl border-4 border-white shadow-[0_15px_35px_rgba(6,48,28,.18)] sm:h-36 sm:w-36">
...
function ProductDetail() {
  ...
  return <Layout><Meta title="Producto en revisión" description="Este producto aún no está disponible en el catálogo verificado de Smart Nutrition." /><main className="mx-auto max-w-[1240px] px-5 py-24 lg:px-8 lg:py-36"><Link href="/salud-y-bienestar" data-testid="link-product-back" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[.14em] text-[#0d7a3f]"><ArrowLeft size={15} /> Volver al catálogo</Link><div className="mt-20 grid gap-12 lg:grid-cols-[.7fr_1.3fr] lg:items-end"><div className="flex h-40 w-40 items-center justify-center rounded-full border border-[#0d7a3f]/20 bg-[#f6fbf8] text-[#0d7a3f]"><HeartHandshake size={42} strokeWidth={1.2} /></div><div><Eyebrow>Referencia {id ? `#${id}` : ''}</Eyebrow><h1 className="font-display text-5xl leading-tight text-[#16241c] sm:text-7xl">Producto aún<br /><em className="not-italic text-[#0d7a3f]">no publicado.</em></h1><p className="mt-7 max-w-xl text-base leading-7 text-[#4b5b52]">No quiero mostrarte información incompleta. Este producto todavía no forma parte del catálogo verificado de Smart Nutrition. Si tienes un nombre específico en mente, escríbeme y lo revisamos juntos.</p><div className="mt-9"><GoldButton message={`Hola Adrian, quiero consultar el producto ${id ?? ''}.`} testId="link-product-whatsapp">Consultar producto</GoldButton></div></div></div></main></Layout>;
}
